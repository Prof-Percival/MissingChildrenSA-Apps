...
partial class EditMissingPersonForm
{
    /// <summary>
    ...
    private void InitializeComponent()
    {
        ...
        MaximizeBox = false;
        MinimizeBox = false;
        Name = "EditMissingPersonForm";
        ShowInTaskbar = false;
        StartPosition = FormStartPosition.CenterScreen;
        Text = "Edit Missing Person";
        Load += EditMissingPersonForm_Load;
