...
public static class ValidationHelper
{
    ...
    public static bool IsValidAndReachableEmailAddress(string emailAddress)
    {
        return IsValidEmailAddress(emailAddress, true) && HasValidMailLookup(emailAddress, true);
    }
